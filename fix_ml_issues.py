...
def fix_ml_enhancements_in_notebook():
    """
    Fix the ML enhancement issues in the notebook
    """
    
    print("🔧 FIXING ML ENHANCEMENT ISSUES")
    print("=" * 50)
    ...
    # Create the fixed ML enhancement cell content
    fixed_ml_cell = {
        "cell_type": "code",
        ...
        "source": [
            "# ============================================================================\n",
            "# FIXED MACHINE LEARNING ENHANCEMENTS FOR SUPPLY CHAIN ANALYSIS\n",
            "# ============================================================================\n",
            "\n",
            "print(\"🤖 INTEGRATING ADVANCED ML CAPABILITIES (FIXED VERSION)\")\n",
            "print(\"=\" * 60)\n",
            "\n",
            ...
            "\n",
            "# ============================================================================\n",
            "# 1. FIXED RISK SCORING SYSTEM IMPLEMENTATION\n",
            "# ============================================================================\n",
            "\n",
            "print(\"\\n🔍 IMPLEMENTING COMPREHENSIVE RISK SCORING SYSTEM (FIXED)\")\n",
            "print(\"=\" * 60)\n",
            "\n",
            ...
            "        \"\"\"Calculate geographic concentration risk (FIXED)\"\"\"\n",
            "        try:\n",
            ...
            "            \n",
            "            # Create individual risk scores for each row\n",
            ...
            "\n",
            "# ============================================================================\n",
            "# 2. FIXED PREDICTIVE ANALYTICS IMPLEMENTATION (NO DATA LEAKAGE)\n",
            "# ============================================================================\n",
            "\n",
            "print(\"\\n🤖 IMPLEMENTING PREDICTIVE ANALYTICS (FIXED - NO LEAKAGE)\")\n",
            "print(\"=\" * 60)\n",
            "\n",
            "class SupplyChainPredictor:\n",
            "    \"\"\"Predictive analytics for supply chain disruptions (FIXED)\"\"\"\n",
            "    \n",
            "    def __init__(self):\n",
            "        self.models = {}\n",
            "        self.feature_names = {}\n",
            ...
            "        \"\"\"Prepare features for ML models (FIXED)\"\"\"\n",
            ...
            "        \"\"\"Build disruption prediction model (FIXED - NO LEAKAGE)\"\"\"\n",
            "        X = self.prepare_features(df, is_training=True)\n",
            "        \n",
            "        # Create disruption target based on efficiency (no leakage)\n",
            ...
            "        \"\"\"Build cost prediction model (FIXED)\"\"\"\n",
            "        X = self.prepare_features(df, is_training=True)\n",
            "        \n",
            ...
            "        \"\"\"Generate predictions for all models (FIXED)\"\"\"\n",
            ...
            "        \n",
            "        print(f\"✅ Predictive models trained successfully (NO LEAKAGE)\")\n",
            ...
            "\n",
            "# ============================================================================\n",
            "# 3. FIXED EXECUTIVE DASHBOARD CREATION\n",
            "# ============================================================================\n",
            "\n",
            "print(\"\\n📊 CREATING EXECUTIVE DASHBOARD (FIXED)\")\n",
            "print(\"=\" * 50)\n",
            "\n",
            "class ExecutiveDashboard:\n",
            "    \"\"\"Executive dashboard for supply chain insights (FIXED)\"\"\"\n",
            "    \n",
            ...
            "\n",
            "# ============================================================================\n",
            "# 4. FIXED ADVANCED VISUALIZATIONS\n",
            "# ============================================================================\n",
            "\n",
            "print(\"\\n📈 CREATING ADVANCED VISUALIZATIONS (FIXED)\")\n",
            "print(\"=\" * 50)\n",
            "\n",
            ...
            "\n",
            "print(\"\\n✅ FIXED MACHINE LEARNING ENHANCEMENTS COMPLETED SUCCESSFULLY!\")\n",
            "print(\"=\" * 60)\n"
        ]
    }
    ...
    for i, cell in enumerate(notebook['cells']):
        if cell['cell_type'] == 'code' and any('MACHINE LEARNING ENHANCEMENTS' in line for line in cell['source']):
            # Replace the existing ML cell with the fixed version
            notebook['cells'][i] = fixed_ml_cell
            break
    
    # Add the summary cell if it doesn't exist
    summary_exists = any(
        cell['cell_type'] == 'markdown' and any('Fixed Machine Learning Enhancements' in line for line in cell['source'])
    ...
    try:
        ...
        print("✅ Successfully fixed ML enhancements in notebook")
...
if __name__ == "__main__":
    success = fix_ml_enhancements_in_notebook()
    if success:
        print("\n🎉 FIXES COMPLETE!")
        print("\n📋 Key Fixes Applied:")
        print("1. Fixed numpy method error in risk scoring")
        print("2. Eliminated data leakage in predictive models")
        print("3. Added proper feature name tracking")
        print("4. Implemented overfitting detection")
        print("5. Enhanced error handling throughout")
    else:
